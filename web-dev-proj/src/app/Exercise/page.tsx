...
const ExercisesPage: React.FC = () => {
    ...
    const fetchExercises = useCallback(async () => {
        try {
            ...
            const userExercises = data.filter((exercise: Exercise) => exercise.email === currentUserEmail);
                        ...
                        exercises.map((exercise, exerciseIndex) => (
                            <div id={style.exercise} key={exerciseIndex}>
                                ...
                                <div id={style.summaries}>
                                    ...
                                    <p id={style.totalVolume}>Total
                                        Volume: {calculateTotalVolume(exercise.sets)} lbs</p>
                                </div>
